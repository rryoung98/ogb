...
class KGEModel(nn.Module):
    ...
    def test_step(model, test_triples, args, entity_dict, random_sampling=False):
        ...
        test_dataloader_head = DataLoader(
            TestDataset(test_triples, args, "head-batch", random_sampling, entity_dict),
        ...
        test_dataloader_tail = DataLoader(
            TestDataset(test_triples, args, "tail-batch", random_sampling, entity_dict),
            batch_size=args.test_batch_size,
            num_workers=max(1, args.cpu_num // 2),
            collate_fn=TestDataset.collate_fn,
        )
            ...
            for test_dataset in test_dataset_list:
                for positive_sample, negative_sample, mode in test_dataset:
                    ...
                    batch_results = model.evaluator.eval(
                        {"y_pred_pos": score[:, 0], "y_pred_neg": score[:, 1:]}
                    )
