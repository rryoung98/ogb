...
class ArgParser(argparse.ArgumentParser):
    def __init__(self):
        ...
        self.add_argument(
            "--data_path", type=str, default="../data", help="root path of all dataset"
        )
        self.add_argument(
        ...
        self.add_argument(
            "-g", "--gamma", type=float, default=12.0, help="margin value"
        )
        self.add_argument(
            "--gpu",
            type=int,
        ...
        self.add_argument(
            "--mix_cpu_gpu", action="store_true", help="mix CPU and GPU training"
        )
        self.add_argument(
            "-de",
            "--double_ent",
        ...
        self.add_argument(
            "--num_thread", type=int, default=1, help="number of thread used"
        )
        self.add_argument(
            "--server_id", type=int, default=0, help="Unique ID of each server"
        )
        self.add_argument(
            "--ip_config",
            type=str,
...
def start_server(args):
    ...
    if my_server.get_id() % my_server.get_group_count() == 0:  # master server
        (
            ...
            relation_emb,
            relation_emb_state,
        ) = get_server_data(args, my_server.get_machine_id())
